    ...
    <div class ="black-bg">
      ...
      <div :class="[ floorFlag==4? 'roomR' : 'white-bg']">
        ...
        <div class="controlButtons">
          ...
          <button class="nothing" @click="nothing"></button>
        </div>
        <!---->
        ...
        <div class="floorDiv" v-if="timeSelectFlag==0">
          <button class="floorSelect" @click="showFloor(1)">1st</button>
          <button class="floorSelect" @click="showFloor(2)">2nd</button>
          <button class="floorSelect" @click="showFloor(3)">3rd</button>
    </div>
      </div>
